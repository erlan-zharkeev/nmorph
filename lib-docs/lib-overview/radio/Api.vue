...
import { NmorphComponentHeight, NmorphRadioStyleType } from "@nmorph/nmorph-ui-kit";
...
<template>
  <div class="docs-api-table">
    <api-table title="NmorphRadio" name="radio" :attributes="attributesData" :slots="slotData" :variables="variables"
      :exposes="exposes" />
  </div>
</template>
