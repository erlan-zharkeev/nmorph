...
<template>
  <div id="content-inactive-value">
    <attribute
      header="Inactive-value"
      :subtitle="$t('overview.switch.inactive-value.subtitle')"
      :codeToCopy="code"
    >
      <template #overview>
        <div class="switch-inactive-value-overview">
          <ClientOnly>
            <NmorphSwitch />
          </ClientOnly>
        </div>
...
<style lang="scss">
.switch-inactive-value-overview {}
</style>
