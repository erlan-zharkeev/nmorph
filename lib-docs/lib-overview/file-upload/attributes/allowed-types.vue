...
<template>
  <div id="content-allowed-types">
    <attribute
      header="Allowed-types"
      :subtitle="$t('overview.file-upload.allowed-types.subtitle')"
      :codeToCopy="code"
    >
      <template #overview>
        <div class="file-upload-allowed-types-overview">
          <ClientOnly>
            <NmorphFile-upload />
          </ClientOnly>
        </div>
...
<style lang="scss">
.file-upload-allowed-types-overview {
}
</style>
