...
import BasicUsageExample from "./BasicUsage.example.vue";
import basicUsageSource from "./BasicUsage.example.vue?raw";
</script>
...
<template>
  <div id="content-basic-usage">
    <DocsExample
      ...
      :subtitle="$t('overview.media-gallery.basic-usage.subtitle')"
