...
<template>
  <div id="content-disabled">
    <Attribute header="Disabled" :subtitle="$t('overview.checkbox.disabled.subtitle')" :codeToCopy="code">
      <template #overview>
        <div class="checkbox-disabled-overview">
          <ClientOnly>
            <NmorphCheckbox disabled :model-value="true" id="3" />
          </ClientOnly>
        </div>
      </template>
      <template #code>
