export default {
  ...
  "guide-page": {
    ...
    "config": {
      "add-сonfig": "Пример добавления конфигурации библиотеки",
  ...
  "about-page": {
    "alpha-test": "Альфа-тестирование",
    "alpha-test-lib":
      "<p>На данный момент библиотека на этапе альфа тестирования.</p><p>Так как на данный момент разработка ведется силами только одного разработчика(меня), исправления возможных багов и тестирование занимает довольно значимое количество времени.</p><p>Буду рад если вы сообщите о каких-либо проблемах.</p>",
    "get-started": "Начать работу",
    overview: "Обзор",
    "overview-content":
      "это библиотека UI-компонентов для Vue 3, разработанная с использованием неуморфического/скевоморфического дизайна. Она предоставляет набор простых компонентов для создания уникального пользовательского интерфейса.",
  ...
  "guide-menu": {
    ...
    theming: "Работа с цветовой cхемой",
  ...
  overview: {
    ...
    dialog: {
      ...
      api: {
        ...
        "z-index":
          "Определяет z-index для управления наложением диалогового окна",
        "close-on-overlay":
