export default {
  ...
  "overview": {
    ...
    "icon": {
      ...
      "color": {
        "subtitle": "Цвет иконки. Вы можете использовать пользовательские цвета или передать доступную переменную."
      },
      "api": {
    ...
    "scroll": {
      ...
      "api": {
        ...
        "scroll-x-prop": "Определяет горизонтальное поведение прокрутки, например *auto* или *hidden*",
    ...
    "badge": {
      "value": {
        "subtitle": "Отображаемое значение на бейдже, может быть *stirng* или *number*."
      },
      "max": {
        "subtitle": "Максимальное значение для бейджа. Если оно было задано как число и превышено, отображается как max+."
      },
      "is-dot": {
    ...
    "image": {
      "fit": {
        ...
        "info": {
          "title": "Информация",
          "content": "Чтобы свойство fit отображалось корректно, убедитесь, что у контейнера задан фиксированный размер."
        }
      },
      "loading-text": {
      ...
      "api": {
        ...
        "close-on-outside-click": "Закрывает предпросмотр при нажатии вне контейнера.",
    ...
    "tag-item": {
      ...
      "removable": {
        "subtitle": "Определяет, может ли компонент быть удален пользователем. Принимает *boolean*.",
        "info": {
          "title": "Информация",
    ...
    "skeleton": {
      "animated": {
        "subtitle": "Включает анимацию для компонента скелетона, если установлено в *true*."
      },
      "loading": {
        "subtitle": "Управляет отображением скелетона."
      },
      "rows": {
        "subtitle": "Определяет количество строк в скелетоне, обычно для симуляции текстового содержимого."
      },
      "api": {
      ...
      "variables": {
        "loading-gradient": "Определяет цвет градиента, используемый во время анимации загрузки скелетона."
      }
    },
    "skeleton-item": {
      "api": {
        "variant": "Определяет тип скелетона для отображения, например, текст или круг.",
    ...
    "progress": {
      "type": {
        "subtitle": "Определяет тип индикатора прогресса, например, *linear* или *circle*."
      },
      "color": {
    ...
    "calendar": {
      "type": {
        "subtitle": "Определяет тип календаря, например, *date* или *dates* выбор."
      },
      "custom-content": {
        "subtitle": ""
      },
      ...
      "api": {
        ...
        "range": "Включает режим выбора диапазона в календаре, позволяя выбирать диапазон дат календаря. Не выбранный диапозон, а диапозон отображемого календаря"
      },
      "slot": {
