export default {
  ...
  "guide-page": {
    ...
    explained: "<b>Neumorphism / Sceumorhism</b>",
    "apply-theme": "Применить тему",
    "main-content":
      "<p>Vue 3&nbsp;библиотека компонентов для создания уникального 3D&nbsp;дизайна в&nbsp;неу(о)морфическом стиле</p><p>Не&nbsp;использует сторонних пакетов</p><p>Менее 900kb!</p>",
    "quick-start": {
