  ...
  "changelog-page": {
    ...
    "changelog": {
      ...
      "items": {
        ...
        "docs-i18n-merge-fix": "Исправлена загрузка локалей документации при объединении внешних переводов nmorph.",
        "docs-ssg-migration": "Сборка документации переведена на статическую генерацию (SSG)."
      }
    },
    "known-bugs": {
