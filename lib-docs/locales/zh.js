export default {
  ...
  "about-page": {
    "alpha-test": "Alpha 测试",
    "alpha-test-lib":
      "<p>目前该库处于 Alpha 测试阶段。</p><p>由于开发工作目前由单一开发者（我）完成，修复可能的 bug 和测试需要相当长的时间。</p><p>如果您发现任何问题，请告诉我。</p>",
    "get-started": "开始使用",
    "overview": "概述",
    "overview-content":
      "这是一个为 Vue 3 开发的 UI 组件库，采用新拟态/伪拟态设计。它提供了一组简单的组件，用于创建独特的用户界面。",
    "neumorphism": "什么是新拟态/伪拟态？",
    "neumorphism-content":
      "<p>新拟态（Neumorphism）是一种设计风格，结合了平面设计和伪拟态元素。</p><p>它通过创建体积感和柔和的阴影，使界面看起来像是可以触摸的。</p><p>新拟态的基础是柔和的颜色、轻微的渐变和柔和的阴影，营造出凸出或凹入元素的效果。</p>"
  },
  "guide-menu": {
    "quick-start": "快速开始",
    "config": "配置",
