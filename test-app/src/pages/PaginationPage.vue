<template>
  <div class="wrapper">
    <NmorphCard>
      <NmorphTable :data="tableData" bordered design="common">
        <NmorphTableColumn prop="date" label="Date" width="180" alignment='left' />
      ...
      <NmorphPagination :total-elements-quantity="tableData.length" :model-value="selectedPage"
        @update:model-value="selectedPageHandler" v-model:range="currentRange" />
    </NmorphCard>
  </div>
</template>
