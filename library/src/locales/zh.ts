...
export const translation: TranslateMessages = {
  ...
  NmorphDatePicker: NmorphDatePicker[Locale.zh],
  NmorphImage: NmorphImage[Locale.zh],
  NmorphSelect: NmorphSelect[Locale.zh],
  NmorphFileUpload: NmorphFileUpload[Locale.zh],
};
