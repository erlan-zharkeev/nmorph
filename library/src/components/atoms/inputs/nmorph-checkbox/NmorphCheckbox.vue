...
const inputValue = hasGroup ? ref(groupSelectedValue.value) : ref(props.modelValue);
...
const handleChange = () => {
  ...
  if (changeValue && Array.isArray(inputValue.value)) changeValue(props.id, inputValue.value);
};
