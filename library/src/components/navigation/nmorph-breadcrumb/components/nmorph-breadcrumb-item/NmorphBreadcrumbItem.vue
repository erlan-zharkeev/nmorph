...
import { NmorphBreadcrumbInjection } from '@/components';
import type { INmorphBreadcrumbItemComponentProps } from './types';

const props = withDefaults(defineProps<INmorphBreadcrumbItemComponentProps>(), {
  to: '',
  replace: false,
});
